...
def make_stats_enemy(min_level, bias):
    ...
    enemy_xp = random.randint(round((enemy_attack + enemy_defense + enemy_health) / (min_level*2), 0), round((enemy_attack + enemy_defense + enemy_health) * bias / min_level, 0))
...
class Character(Actor):
    ...
    def __init__(self, name, hp, max_hp, attack, defense, mana, max_mana, stamina, max_stamina, xp, level, gold, inventory, mode, battling, user_id):
...
class GiantSpider(Enemy):
    ...
    stat = make_stats_enemy(min_level, bias)
    def __init__(self):
        super().__init__("Giant Spider", self.stat[0],self.stat[1],self.stat[2],self.stat[3],self.stat[4]) # HP, attack, defense, XP, gold
...
class Bat(Enemy):
    ...
    stat = make_stats_enemy(min_level, bias)
    def __init__(self):
        super().__init__("Bat", self.stat[0],self.stat[1],self.stat[2],self.stat[3],self.stat[4]) # HP, attack, defense, XP, gold
...
class Wolf(Enemy):
    ...
    stat = make_stats_enemy(min_level, bias) 
    def __init__(self):
        super().__init__("Wolf", self.stat[0],self.stat[1],self.stat[2],self.stat[3],self.stat[4]) # HP, attack, defense, XP, gold
...
class Ogre(Enemy):
    ...
    stat = make_stats_enemy(min_level, bias)
    def __init__(self):
        super().__init__("Ogre", self.stat[0],self.stat[1],self.stat[2],self.stat[3],self.stat[4]) # HP, attack, defense, XP, gold
...
class Living_Armor(Enemy):
    ...
    stat = make_stats_enemy(min_level, bias)
    def __init__(self):
        super().__init__("Living Armor", self.stat[0],self.stat[1],self.stat[2],self.stat[3],self.stat[4]) # HP, attack, defense, XP, gold
...
class Bear(Enemy):
    ...
    stat = make_stats_enemy(min_level, bias)
    def __init__(self):
        super().__init__("Bear", self.stat[0],self.stat[1],self.stat[2],self.stat[3],self.stat[4]) # HP, attack, defense, XP, gold
...
class Drake(Enemy):
    ...
    stat = make_stats_enemy(min_level, bias)
    def __init__(self):
        super().__init__("Lesser Drake", self.stat[0],self.stat[1],self.stat[2],self.stat[3],self.stat[4]) # HP, attack, defense, XP, gold
